...
try
	...
	% Add -largeArrayDims on 64-bit machines of MATLAB
        ...
        mex CFLAGS= -largeArrayDims libsvmread.c
		mex CFLAGS= -largeArrayDims libsvmwrite.c
		mex CFLAGS= -I.. -largeArrayDims train.c linear_model_matlab.c ../linear.cpp ../tron.cpp ../blas/daxpy.c ../blas/ddot.c ../blas/dnrm2.c ../blas/dscal.c
		mex CFLAGS= -I.. -largeArrayDims predict.c linear_model_matlab.c ../linear.cpp ../tron.cpp ../blas/daxpy.c ../blas/ddot.c ../blas/dnrm2.c ../blas/dscal.c
	end
